...
/* 	/1* Here, we use the term *pointer* to differentiate the cursor */
/* 	 * one sees when hovering the mouse over the terminal from, e.g., */
/* 	 * a green rectangle where text would be entered. *1/ */
/* 	Cursor vpointer, bpointer; /1* visible and hidden pointers *1/ */
/* 	int pointerisvisible; */
/* 	int scr; */
/* 	int isfixed; /1* is fixed geometry? *1/ */
/* 	int l, t; /1* left and top offset *1/ */
/* 	int gm; /1* geometry mask *1/ */
/* 	int tw, th; /1* tty width and height *1/ */
/* 	int w, h; /1* window width and height *1/ */
/* 	int ch; /1* char height *1/ */
/* 	int cw; /1* char width  *1/ */
/* 	int depth; /1*  bit depth *1/ */
/* 	char state; /1* focus, redraw, visible *1/ */
/* 	int cursor; /1* cursor style *1/ */
/* } XWindow; */
...
/* /1* Internal representation of the screen *1/ */
/* typedef struct { */
/* 	int row;      /1* nb row *1/ */
/* 	int col;      /1* nb col *1/ */
/* 	Line *line;   /1* screen *1/ */
/* 	Line *alt;    /1* alternate screen *1/ */
/* 	int *dirty;  /1* dirtyness of lines *1/ */
/* 	XftGlyphFontSpec *specbuf; /1* font spec buffer used for rendering *1/ */
/* 	TCursor c;    /1* cursor *1/ */
/* 	int top;      /1* top    scroll limit *1/ */
/* 	int bot;      /1* bottom scroll limit *1/ */
/* 	int mode;     /1* terminal mode flags *1/ */
/* 	int esc;      /1* escape state flags *1/ */
/* 	char trantbl[4]; /1* charset table translation *1/ */
/* 	int charset;  /1* current charset *1/ */
/* 	int icharset; /1* selected charset for sequence *1/ */
/* 	int numlock; /1* lock numbers in keyboard *1/ */
/* 	int *tabs; */
/* } Term; */
...
/* 	Line *line;   /1* screen *1/ */
/* 	Line *alt;    /1* alternate screen *1/ */
/* 	Line hist[histsize]; /1* history buffer *1/ */
/* 	int histi;    /1* history index *1/ */
/* 	int scr;      /1* scroll back *1/ */
/* 	int *dirty;  /1* dirtyness of lines *1/ */
/* 	XftGlyphFontSpec *specbuf; /1* font spec buffer used for rendering *1/ */
/* 	TCursor c;    /1* cursor *1/ */
/* 	int top;      /1* top    scroll limit *1/ */
